...
import {StyledBasket, BasketImg, AmountBasket, Amount, ListBasket, CloseBasket, ItemBasketName, BasketItem, AmountText, AmountSpace, AmountInput, RemoveSpace, BuyProduct, RemoveProduct} from './Styles'
